...
| ADR | Title | Status |
|---|---|---|
| [0001](./0001-orchestrate-extraction-with-temporal.md) | Orchestrate document field extraction with a Temporal workflow | Proposed |
| [0002](./0002-host-model-on-bedrock.md) | Host the extraction model on AWS Bedrock (Claude Opus 4.8) | Proposed |
