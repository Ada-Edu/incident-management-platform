...
/**
 * Lightweight native <select> styled to match the design system. Kept simple
 * (native element) for reliable form behaviour and accessibility; swap for a
 * Radix Select later if custom option rendering is needed.
 */
